...
{
	pic.LoadBitmap(IDB_FINAL_FANTASY);
}
...
void CBouncingBall::SetFloor(int f)
{
	this->floor = f;
}

void CBouncingBall::SetVelocity(int v)
{
	this->velocity = this->initial_velocity = v;
}
...
void CGameStateRun::OnInit()  								// 遊戲的初值及圖形設定
{
	...
	// practice
	practice.LoadBitmap(IDB_FINAL_FANTASY);
